...
public class DocumentReview extends javax.swing.JPanel {
    ...
    private void setupTheme() {
        ...
        DocQueueJPanel.setBorder(createShadowBorder());
        declarDetailsJPanel.setBorder(createShadowBorder());
        docInfoJPanel.setBorder(createShadowBorder());
        docContenJPanel.setBorder(createShadowBorder());
        reviewNotesJPanel.setBorder(createShadowBorder());
        
        // Style buttons
        styleActionButton(btnBack);
        styleActionButton(btnSearch);
        styleActionButton(btnApprove);
        styleActionButton(btnReject);
        styleActionButton(btnRequestInfo);
        
        // Style the approval button with special color
        btnApprove.setBackground(new java.awt.Color(0, 128, 0)); // Green color for approval
        
        // Style the reject button with special color
        btnReject.setBackground(new java.awt.Color(178, 34, 34)); // Red color for rejection
        ...
        // Style text area
        styleTextArea(txtDocPreview);
        
        // Style labels
        styleTitleLabel(lblTitle);
        styleTitleLabel(lblListTitle);
        styleTitleLabel(lblDocInfo);
        styleTitleLabel(lblDocContent);
    ...
    private void styleTextArea(javax.swing.JTextArea textArea) {
        ...
        textArea.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(90, 141, 224), 1));
