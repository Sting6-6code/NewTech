 ...
 * @author zhuchenyan
 */
public class LogisticsAdminHP extends AdminHP {
    ...
    private LogisticsGroupEnterprise logisticsEnterprise;
    private LogisticsOrganization logisticsOrg;
    
    /**
     * Creates new form LogisticsAdminHP
     */
    public LogisticsAdminHP(JPanel jp, UserAccount ua, Enterprise e, AdminOrganization o, EcoSystem b) {
        this.workArea = jp;
        this.account = ua;
        this.enterprise = e;
        this.adminOrg = o;
        ...
        // Initialize logistics enterprise and organization
        if (e instanceof LogisticsGroupEnterprise) {
            this.logisticsEnterprise = (LogisticsGroupEnterprise) e;
            // Find logistics organization
            for (Organization org : e.getOrganizationDirectory().getOrganizationList()) {
                if (org instanceof LogisticsOrganization) {
                    this.logisticsOrg = (LogisticsOrganization) org;
                    break;
                }
            }
        }
        ...
        // Set welcome message for logistics admin
    ...
    private void setupButtonActions() {
        ...
        // Navigation buttons
        btnViewShipment.addActionListener(evt -> btnViewShipmentActionPerformed(evt));
        btnViewCus.addActionListener(evt -> btnViewCusActionPerformed(evt));
    ...
    private void initComponents() {
        ...
        btnViewShipment.setText("View Shipment");
        btnViewShipment.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnViewShipmentActionPerformed(evt);
            }
        });

        btnViewCus.setText("View Customs");
    ...
    private void btnViewShipmentActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewShipmentActionPerformed
        // TODO add your handling code here:
        JPanel container = (JPanel) getParent();
        CardLayout layout = (CardLayout) container.getLayout();
        
        // Create shipment panel and pass necessary parameters
        ...
        container.add("ShipmentPanel", shipmentPanel);
        layout.show(container, "ShipmentPanel");
    }//GEN-LAST:event_btnViewShipmentActionPerformed
    ...
    private void btnViewCusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewCusActionPerformed
        ...
        // Create a null shipment for the constructor since it's required
        Shipment nullShipment = null;
        
        // Create documentation details panel and pass necessary parameters
        DocumentationDetails docsPanel = new DocumentationDetails(
                container, 
                account, 
                enterprise, 
                logisticsOrg,
        ...
        container.add("DocumentationDetails", docsPanel);
        layout.show(container, "DocumentationDetails");
   ...
   /**
     * Apply theme to all components in LogisticsAdminHP
     */
